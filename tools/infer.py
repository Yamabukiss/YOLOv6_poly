...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--weights', type=str, default=r'D:\yolov6_self\YOLOv6\result\s_config_result\weights\best_0.29064551977690406_ckpt.pt', help='model path(s) for inference.')
